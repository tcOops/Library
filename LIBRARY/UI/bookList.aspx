		...
		<h3>图书列表</h3>
			...
			<table style="border-width:0px;border-collapse:collapse;width:100%">
				<tr style="background-color:#E0E0E0;border-width:0px">
                    ...
                    <td style="width:6%;border-width:0px;font-weight:bold;text-align:center">是否存在</td>
            ...
            <% foreach (var book in bookList){ %>
                <tr style="background-color:#E0E0E0;border-width:0px">
                    ...
                    <td style="width:6%;border-width:0px;text-align:center"><%=book.Is_deleted%></td>
