...
implementation
uses fHFReaderdemomain,HFReader_Head;
{$R *.dfm}
  ...
  begin
    ...
    begin
       ...
       begin
         ...
         dwNo:=frmHFReaderdemomain.ListView1.Items.Count;
         aListItem := frmHFReaderdemomain.ListView1.Items.Add;
         aListItem.SubItems.Add('');
         aListItem.SubItems.Add('');
         aListItem.SubItems.Add('');//
         aListItem.SubItems.Add('');//
         aListItem.Caption:=IntToStr(frmHFReaderdemomain.ListView1.Items.Count);
         str:=Copy(fRecvUDPstring,2,Pos('/',fRecvUDPstring)-2);
         if(m_ipctrl<>RemostIP)then Break;
         frmHFReaderdemomain.ListView1.Items[dwNo].SubItems[0]:=str;
         frmHFReaderdemomain.ListView1.Items[dwNo].SubItems[1]:=RemostIP;
         ...
         frmHFReaderdemomain.ListView1.Items[dwNo].SubItems[2]:=str;
         Break;
       end;
    end;
  end;
